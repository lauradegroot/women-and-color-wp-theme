...
## womenandcolor: A MINIMUM VIABLE THEME
...
* To make this script *optional* requires a bit more work:
    * Add an option to `functions-config-defaults.php`: `defined( 'womenandcolor_SCRIPTS_HEADROOM' ) || define( 'womenandcolor_SCRIPTS_HEADROOM', true );`.
    * Add the switch to `inc/assets.php`: `if ( womenandcolor_SCRIPTS_HEADROOM ) : $script_name .= '-hr';`.
