...
function womenandcolor_setup() {

  // Language loading
  load_theme_textdomain( 'womenandcolor', trailingslashit( get_template_directory() ) . 'languages' );
  ...
  register_nav_menu( 'header', __( 'Header menu', 'womenandcolor' ) );
  register_nav_menu( 'footer', __( 'Footer menu', 'womenandcolor' ) );

}
add_action( 'after_setup_theme', 'womenandcolor_setup', 11 );

// Sidebar declaration
function womenandcolor_widgets_init() {
  register_sidebar( array(
    'name'          => __( 'Main sidebar', 'womenandcolor' ),
    'id'            => 'sidebar-main',
    'description'   => __( 'Appears to the right side of most posts and pages.', 'womenandcolor' ),
...
add_action( 'widgets_init', 'womenandcolor_widgets_init' );
